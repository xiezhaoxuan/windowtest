...
int Motor1_Param1=0;  ///电机的第一个参数，即水平转速
int Motor1_Param2=0;  ///电机的第二个参数，即触发延时，指检测到到位信号后多长时间开始显示
int Motor1_Param3=0;  ///电机的第三个参数，即脉宽时间，指激光开启的时间
int Motor1_Param4=0;  ///电机的第四个参数，即间隔时间，指激光关闭的时间
...
LRESULT CALLBACK WndProc(HWND hwnd,UINT message,WPARAM wParam,LPARAM lParam)
{
	...
	switch(message)
	{
		case WM_CREATE:
			...
			SetScrollPos(hwndScroll1,SB_CTL,Motor1_Param2,TRUE);
			...
			SetScrollPos(hwndScroll1,SB_CTL,Motor1_Param3,TRUE);
			...
			SetScrollPos(hwndScroll1,SB_CTL,Motor1_Param4,TRUE);
